...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview);case NetworkEvent_ChannelMessageReceived() when channelMessageReceived != null:
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview);case NetworkEvent_MessageSent() when messageSent != null:
...
return fileHeaderReceived(_that.fileId,_that.fileName,_that.sizeBytes,_that.isImage,_that.width,_that.height,_that.messageId,_that.senderId,_that.serverId,_that.channelId,_that.videoThumb);case NetworkEvent_FileProgress() when fileProgress != null:
...
return webRtcSendFile(_that.peerId,_that.transferId,_that.filePath,_that.totalSize,_that.kind,_that.shardIndex);case NetworkEvent_CallSignal() when callSignal != null:
...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview);case NetworkEvent_ChannelMessageReceived():
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview);case NetworkEvent_MessageSent():
...
return fileHeaderReceived(_that.fileId,_that.fileName,_that.sizeBytes,_that.isImage,_that.width,_that.height,_that.messageId,_that.senderId,_that.serverId,_that.channelId,_that.videoThumb);case NetworkEvent_FileProgress():
...
return webRtcSendFile(_that.peerId,_that.transferId,_that.filePath,_that.totalSize,_that.kind,_that.shardIndex);case NetworkEvent_CallSignal():
...
class NetworkEvent_MessageReceived extends NetworkEvent {
  const NetworkEvent_MessageReceived({required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,fromPeer,text,timestamp,messageId,replyToMid,linkPreview);

@override
String toString() {
  return 'NetworkEvent.messageReceived(fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview)';
}
...
@useResult
$Res call({
 String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,}) {
...
class NetworkEvent_ChannelMessageReceived extends NetworkEvent {
  const NetworkEvent_ChannelMessageReceived({required this.serverId, required this.channelId, required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,text,timestamp,messageId,replyToMid,linkPreview);

@override
String toString() {
  return 'NetworkEvent.channelMessageReceived(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,}) {
...
class NetworkEvent_FileHeaderReceived extends NetworkEvent {
  const NetworkEvent_FileHeaderReceived({required this.fileId, required this.fileName, required this.sizeBytes, required this.isImage, this.width, this.height, required this.messageId, required this.senderId, required this.serverId, required this.channelId, this.videoThumb}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_FileHeaderReceived&&(identical(other.fileId, fileId) || other.fileId == fileId)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.sizeBytes, sizeBytes) || other.sizeBytes == sizeBytes)&&(identical(other.isImage, isImage) || other.isImage == isImage)&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.videoThumb, videoThumb) || other.videoThumb == videoThumb));
}


@override
int get hashCode => Object.hash(runtimeType,fileId,fileName,sizeBytes,isImage,width,height,messageId,senderId,serverId,channelId,videoThumb);

@override
String toString() {
  return 'NetworkEvent.fileHeaderReceived(fileId: $fileId, fileName: $fileName, sizeBytes: $sizeBytes, isImage: $isImage, width: $width, height: $height, messageId: $messageId, senderId: $senderId, serverId: $serverId, channelId: $channelId, videoThumb: $videoThumb)';
}
...
@useResult
$Res call({
 String fileId, String fileName, BigInt sizeBytes, bool isImage, int? width, int? height, String messageId, String senderId, String serverId, String channelId, VideoThumbRef? videoThumb
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fileId = null,Object? fileName = null,Object? sizeBytes = null,Object? isImage = null,Object? width = freezed,Object? height = freezed,Object? messageId = null,Object? senderId = null,Object? serverId = null,Object? channelId = null,Object? videoThumb = freezed,}) {
...
class NetworkEvent_WebRtcSendFile extends NetworkEvent {
  const NetworkEvent_WebRtcSendFile({required this.peerId, required this.transferId, required this.filePath, required this.totalSize, required this.kind, required this.shardIndex}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_WebRtcSendFile&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.transferId, transferId) || other.transferId == transferId)&&(identical(other.filePath, filePath) || other.filePath == filePath)&&(identical(other.totalSize, totalSize) || other.totalSize == totalSize)&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.shardIndex, shardIndex) || other.shardIndex == shardIndex));
}


@override
int get hashCode => Object.hash(runtimeType,peerId,transferId,filePath,totalSize,kind,shardIndex);

@override
String toString() {
  return 'NetworkEvent.webRtcSendFile(peerId: $peerId, transferId: $transferId, filePath: $filePath, totalSize: $totalSize, kind: $kind, shardIndex: $shardIndex)';
}
...
@useResult
$Res call({
 String peerId, String transferId, String filePath, BigInt totalSize, String kind, int shardIndex
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? transferId = null,Object? filePath = null,Object? totalSize = null,Object? kind = null,Object? shardIndex = null,}) {
