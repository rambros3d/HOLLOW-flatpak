...
return licenseError(_that);case _:
  return orElse();
...
return licenseError(_that.reason);case _:
  return orElse();
...
return licenseError(_that.reason);}
}
